 ...
 * [ApiKeyMessageResolver], then replies to the requesting node. See the `companion-protocol`
 * module for the wire contract shared with the mobile module.
 */
  ...
  private fun reply(sourceNodeId: String, requestId: String, outcome: CompanionSignInOutcome) {
    Wearable.getMessageClient(this)
      ...
      .addOnFailureListener { e ->
        Log.w(TAG, "Failed to send sign-in reply to $sourceNodeId", e)
      }
  }
}
