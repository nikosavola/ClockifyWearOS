...
android {
  ...
  // release.yml or the Play Store yet. assembleDebug is enough to build, test, and side-load it
  // during development. Minification/shrinking is still enabled for
